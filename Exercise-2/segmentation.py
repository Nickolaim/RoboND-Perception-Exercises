...
def pcl_callback(pcl_msg):
    ...
    input_pcl = ros_to_pcl(pcl_msg)

    # Create a VoxelGrid filter object for our input point cloud
    vox = input_pcl.make_voxel_grid_filter()
    ...
    # Extract inliers
    pcl_table = pass_through_filtered.extract(inliers, negative=False)
    ...
    white_cloud = XYZRGB_to_XYZ(pcl_objects)  # Apply function to convert XYZRGB to XYZ
